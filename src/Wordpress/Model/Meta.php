...
class Meta {
    ...
    public function get_post_meta($single = false){
        return $this->ServiceModel->get_post_meta( $this->type->getID(), $this->key, $single );
    }
    ...
    public function add_post_meta($unique = false){
        return $this->ServiceModel->get_post_meta( $this->type->getID(), $this->key, $this->value, $unique );
    }
    ...
    public function update_post_meta($prev_value = false){
        return $this->ServiceModel->get_post_meta( $this->type->getID(), $this->key, $this->value, $prev_value );
    }
